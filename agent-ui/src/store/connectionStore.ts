...
export interface ConnectionConfig {
  ...
  /** Cloud proxy base URL. When set (e.g. injected by an embedder via
   *  mountAgentPanel), it overrides the build-time VITE_PROXY_URL/VITE_BASE_URL
   *  — the proxy analogue of `brainEndpoint`. */
