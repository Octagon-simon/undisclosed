...
interface ElectronAPI {
  ...
  codeEditorProvisioned: () => Promise<boolean>;
  codeEditorProvision: () => Promise<{ success: boolean; error?: string }>;
  onCodeEditorProgress: (
  ...
  codeEditorStop: (projectId: string) => Promise<{ success: boolean }>;
  codeEditorStatus: (
    projectId: string
