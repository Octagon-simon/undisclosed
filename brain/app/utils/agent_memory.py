...
_SNAPSHOT_MESSAGE_CONTENT_CAP = _env_int("UNDISCLOSED_SNAPSHOT_MESSAGE_CAP", 4000)
_SNAPSHOT_TOOL_ARG_CAP = _env_int("UNDISCLOSED_SNAPSHOT_TOOL_ARG_CAP", 2000)
_SNAPSHOT_TASK_FIELD_CAP = _env_int("UNDISCLOSED_SNAPSHOT_TASK_FIELD_CAP", 8000)
