...
class ApprovalDecision(BaseModel):
    """Body for POST /chat/{id}/approval — a human decision on a pending
    approval request surfaced through the SSE stream."""

    approval_id: str
    decision: str  # approve/approved or deny/denied
